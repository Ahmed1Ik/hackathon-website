...
// Function to check if all fields are filled and units are different
function checkFields() {
  ...
  // Enable the button if all fields are filled and units are different
...
// Call checkFields() when the page loads to initialize button state
